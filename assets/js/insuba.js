(function ($) {
  ...
  if ($(".contact__form__insurance-progress-range").length) {
    $(".contact__form__insurance-progress-range").each(function () {
      let balanceTag = $(this).find(".contact__form__insurance-balance span");
      let balanceInput = $(this).find(".contact__form__insurance-balance__input");
  ...
  // Date Picker
  if ($(".insuba-datepicker").length) {
    $(".insuba-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  if ($(".insurance-sidebar__nav").length) {
    // dynamic current class
    let mainNavUL = $(".insurance-sidebar__nav");
    dynamicCurrentMenuClass(mainNavUL);
  }
  ...
  //accordion
  if ($(".insuba-accordion").length) {
    var accordionGrp = $(".insuba-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".insuba-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".insuba-accordion." + accordionName)
                .find(".accordion")
  ...
  function thmOwlInit() {
    // owl slider
    let insubaowlCarousel = $(".insuba-owl__carousel");
    if (insubaowlCarousel.length) {
    ...
    let insubaowlCarouselNav = $(".insuba-owl__carousel--custom-nav");
    if (insubaowlCarouselNav.length) {
      insubaowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let insubaowlCarouselCustomDots = $(".insuba-owl__carousel--custom-dots");
    if (insubaowlCarouselCustomDots.length) {
      insubaowlCarouselCustomDots.each(function () {
        let elm = $(this);
        let insubaowlCarouselThumb = elm.data("thumb-elm");
        $(insubaowlCarouselThumb).each(function () {
          let self = $(this);
  ...
  //Strech Column
  function insuba_stretch() {
    var i = $(window).width();
    $(".row .insuba-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function insubaChart() {
    if ($(".insuba-chart").length) {
      $(".insuba-chart").each(function () {
        let self = $(this);
